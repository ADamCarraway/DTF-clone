    ...
    public function run()
    {
        \App\Models\Category::query()->insert([
            ...
            [
                'title'=> 'Жизнь',
                'slug'=> 'life',
                'description' => 'Жизнь — это подсайт о том, что касается массовой культуры косвенно и не попадает в основную тематику noCONTEXT. Фото Кодзимы с друзьями, новости о том, как PlayStation спас кому-то жизнь, интервью Джонни Деппа, где он рассказывает, как страшно пил на съёмках, необычная рекламная кампания Pornhub или очередная интересная нейросеть. Всё это сюда.',
            ...
            [
                'title'=> 'Почитать',
                'slug'=> 'read',
                'description' => 'Сообщество любителей книг и комиксов — noCONTEXT читающий собирается здесь. Место, где мы обсуждаем, что стоит почитать, а что не стоит.',
            ...
            [
                'title'=> 'Инди',
                'slug'=> 'indie',
                'description' => 'Истории из жизни инди-разработчиков. Если вы вдруг делаете свою игру, то это лучшее место, где о ней можно рассказать всему noCONTEXT.',
            ...
            [
                'title'=> 'Офтоп',
                'slug'=> 'flood',
                'description' => 'Здесь можно писать о чём угодно, что касается основных тематик noCONTEXT и соответствует интересам пользователей сайта, но по каким то причинам для этого сейчас нет подсайта.',
            ...
            [
                'title'=> 'Вопросы',
                'slug'=> 'ask',
                'description' => 'Место, где вы можете задать вопрос всему noCONTEXT. И вам даже ответят! Возможно.',
            ...
            [
                'title'=> 'Мемы',
                'slug'=> 'kek',
                'description' => 'Мемы на noCONTEXT. На тему игр и не только. ¯\_(ツ)_/¯',
            ...
            [
                'title'=> 'Наука',
                'slug'=> 'science',
                'description' => 'Научное сообщество на noCONTEXT. Доступно — о сложном. // Развернутые правила общения, связь с командой подсайта, гайдлайны - в нашем Дискорде https://discord.gg/4Wdbtzp',
